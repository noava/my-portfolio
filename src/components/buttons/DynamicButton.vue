...
.funky-button {
  ...
  font-style: italic;
  font-weight: 900;
  color: var(--button-text-color, $background); /* Default text color */
  background-color: var(--button-bg-color, $primary); /* Default background color */
  border: 3px solid var(--button-border-color, $secondary); /* Default border color */
  border-radius: 50rem;
  box-shadow:
